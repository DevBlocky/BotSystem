...
public abstract class BotCommand {
     ...
     * @param m The CommandModule to set the parent to
     */
     ...
     * @param m The message to specify
    ...
    /**
     * An internal command to get the required permission of the bot to invoke the command
