...
/**
 * Module for BotSystem with no purpose other that for testing and making sure the bot is well
 * When ever you type "ping" into chat, it replies with "Pong!"
 * @author BlockBa5her
 *
 */
public class PingPongModule extends BotSystemModule {
	 ...
	 * @param event The event to be used in the handle
	 */
