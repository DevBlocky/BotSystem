package com.blockybot.modules.display;
...
/**
 * Module for BlockyBot about changing the basic discord information of the bot
 * Name, Game, Status ETC
 * 
 * @author BlockBa5her
 *
 */
public class DisplayModule extends BlockyBotModule {

    private JSONObject conf; // the config of the bot
    ...
    public DisplayModule() {
        this.conf = Main.getConf(); // getting config from "Main"
    }
    ...
    private void updateBot() {
        Main.reloadConfig(); // reload config
