package com.blockybot.console.commands;
...
public class ConsoleCommands extends Thread implements Iterable<ConsoleCommand> {
     ...
     */
    public ConsoleCommands(BlockyBot bot) {
        this.bot = bot;
        commands = new LinkedList<>();
    }

    /**
     * Getter for the BlockyBot API
     * 
     * @return Returning BlockyBot API
     */
     ...
     */
    public ConsoleCommands(BlockyBot bot, ConsoleCommand[] initialCommands) {
        this(bot);
